...
// @route   GET /api/queue
// @desc    Get queue list with filters
...
// @desc    Get single queue entry details
// @access  Private (Hospital Admin)
router.get('/:queueId', requireHospitalAdmin, async (req, res) => {
  try {
...
// @access  Private (Hospital Admin)
router.put('/:queueId/status', requireHospitalAdmin, async (req, res) => {
  try {
...
// @route   PUT /api/queue/:queueId
// @desc    Update queue entry
// @access  Private (Hospital Admin)
router.put('/:queueId', requireHospitalAdmin, async (req, res) => {
  try {
    const {
      scheduledTime,
      priority,
...
// @access  Private (Hospital Admin)
router.delete('/:queueId', requireHospitalAdmin, async (req, res) => {
  try {
    const queue = await Queue.findOneAndUpdate(
      {
        _id: req.params.queueId,
