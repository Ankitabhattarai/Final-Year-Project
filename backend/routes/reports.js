...
// @desc    Get summary report for date range
// @access  Private (Hospital Admin)
router.get('/summary', requireHospitalAdmin, async (req, res) => {
  try {
...
// @desc    Get detailed report with all appointments
// @access  Private (Hospital Admin)
router.get('/detailed', requireHospitalAdmin, async (req, res) => {
  try {
    const { 
      startDate, 
      endDate, 
...
// @access  Private (Hospital Admin)
router.get('/doctor-performance', requireHospitalAdmin, async (req, res) => {
  try {
    const { startDate, endDate } = req.query;
    const hospitalId = req.hospitalId;
...
// @access  Private (Hospital Admin)
router.get('/export/csv', requireHospitalAdmin, async (req, res) => {
  try {
